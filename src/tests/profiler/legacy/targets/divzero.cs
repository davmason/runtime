...
namespace LegacyTestTargetsImpl.divzero
{
    using System;
    ...
    public class C
    {
        ...
        public static void divzero(string[] args)
        {
            F1();
            T();
        }
        ...
        public static void R()
        {
            ...
            // We want to test two types of exceptions.
        ...
        public static void T()
        {
            ...
            // The following code is skipped by default.
            // To activate, set g to true from the debugger.
            // The intention is to generate unhandled
            // exceptions on a thread other than main.
            if (g)
            {
