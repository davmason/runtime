...
// implementations in the test module to TestProfiler.
// 
// ======================================================================================
...
typedef HRESULT (STDMETHODCALLTYPE *FC_VERIFY)(IPrfCom * pPrfCom);
...
typedef HRESULT (STDMETHODCALLTYPE *FC_PROFILERDETACHSUCCEEDED)(IPrfCom * pPrfCom);
...
typedef struct _MODULEMETHODTABLE_ 
{
    ...
    FC_PROFILERDETACHSUCCEEDED PROFILERDETACHSUCCEEDED;
