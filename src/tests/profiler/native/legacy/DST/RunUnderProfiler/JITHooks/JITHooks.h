...
extern const GUID CLSID_JITHooks = { 0x229c6917, 0x28e3, 0x48aa, { 0xbe, 0xea, 0x34, 0x3a, 0x68, 0x16, 0x88, 0xaf } };


/***************************************************************************************
 ********************                JITHooks Declaration           ********************
 ***************************************************************************************/

class CJITHooks 
  : public CComObjectRootEx<CComMultiThreadModel>,
    public CComCoClass<CJITHooks, &CLSID_JITHooks>,
    public ICorProfilerCallback2
{
public:
    DECLARE_REGISTRY_RESOURCE(JITHooks);

    DECLARE_CLASSFACTORY()
    BEGIN_COM_MAP(CJITHooks)
...
OBJECT_ENTRY_AUTO(CLSID_JITHooks, CJITHooks);
