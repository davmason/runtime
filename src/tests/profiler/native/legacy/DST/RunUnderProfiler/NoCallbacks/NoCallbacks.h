...
extern const GUID CLSID_NoCallbacks = { 0x3165ccf7, 0x6528, 0x4d77, { 0x89, 0xb, 0xe2, 0xd8, 0xff, 0xb, 0xe3, 0x30 } };

/***************************************************************************************
 ********************                NoCallbacks Declaration           ********************
 ***************************************************************************************/

class CNoCallbacks 
  : public CComObjectRootEx<CComMultiThreadModel>,
    public CComCoClass<CNoCallbacks, &CLSID_NoCallbacks>,
    public ICorProfilerCallback2
{
public:
    DECLARE_REGISTRY_RESOURCE(NoCallbacks);

    DECLARE_CLASSFACTORY()
    BEGIN_COM_MAP(CNoCallbacks)
...
OBJECT_ENTRY_AUTO(CLSID_NoCallbacks, CNoCallbacks);
