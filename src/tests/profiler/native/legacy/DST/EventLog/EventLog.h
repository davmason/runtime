...
#ifndef __PROFILER_TEST_EVENT_LOG__
#define __PROFILER_TEST_EVENT_LOG__
...
extern const GUID CLSID_EVENTLOG = { 0xa905758c, 0x2277, 0x4467, { 0xbe, 0x84, 0xfd, 0xa0, 0x9b, 0xc6, 0x38, 0xda } };
...
class CEventLog 
  : public CComObjectRootEx<CComMultiThreadModel>,
    public CComCoClass<CEventLog, &CLSID_EVENTLOG>,
    public ICorProfilerCallback3
{
public:
    DECLARE_REGISTRY_RESOURCE(EventLog);

    DECLARE_CLASSFACTORY()
    BEGIN_COM_MAP(CEventLog)
        ...
        COM_INTERFACE_ENTRY_FUNC(IID_ICorProfilerCallback3, 0, (ATL::_ATL_CREATORARGFUNC *)OnQIForCallback3)
    END_COM_MAP()
    ...
    virtual HRESULT STDMETHODCALLTYPE SurvivingReferences(          /* [in] */ ULONG    cSurvivingObjectIDRanges,
                                                                    ...
                                                                    /* [in] */ ULONG    cObjectIDRangeLength[]) { return S_OK; };
    virtual HRESULT STDMETHODCALLTYPE InitializeForAttach(          /* [in] */ IUnknown * pCorProfilerInfoUnk,
...
OBJECT_ENTRY_AUTO(CLSID_EVENTLOG, CEventLog);
