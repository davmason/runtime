...
{
    class shadowstackfastwithdsselt31
    {
        static readonly Guid ShadowStackFastWithDSSELT3Guid = new Guid("TODO: add guid");
        public static int Main(string[] args)
        {
            ...
            return ProfilerTestRunner.Run(profileePath: System.Reflection.Assembly.GetExecutingAssembly().Location,
                                          ...
                                          profilerClsid: ShadowStackFastWithDSSELT3Guid);
        }
    }
}
